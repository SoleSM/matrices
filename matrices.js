...
//FUNCIONES QUE DEBEMOS DEFINIR PARA CREAR LAS MATRICES
...
//Recoge los datos del formulario y los guarda en las matrices
function Cargar () {
	var q = 0;
...
//Comprueba dimensiones de las matrices
function Comprobar () {
	...
	if (isNaN(filaA) || isNaN(colA) || isNaN(filaB) || isNaN(colB)) {
		...
		alert("Dimensiones de las matrices no válidas.El número de columnas de A debe ser\nigual al número de filas de B.");
	}
	else {
		if (contador > 0) {
			Borrar ()
